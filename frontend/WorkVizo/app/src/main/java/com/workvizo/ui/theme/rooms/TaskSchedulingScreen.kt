    ...
    Column(
        ...
        Button(
            ...
            onClick = {
                ...
                if (tasks.any { it.taskName.value.isBlank() }) {
                    error = "Please fill all task names"
                    return@Button
                }
...
fun TaskCard(taskNo: Int, task: TaskDraft, poppins: FontFamily) {
    Card(
        ...
        Column(Modifier.padding(18.dp)) {
            ...
            VisibleInput("People", "2", task.people.value, poppins) {
                task.people.value = it.filter(Char::isDigit)
            }
        }
    }
}
